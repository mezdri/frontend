...
<template>
  <div>
    <div v-if="!detalleVehiculoHomeRendered" id="drawerDivSetup">
      ...
      <v-toolbar dark color="#27488E" app :clipped-left="clipped">
        <v-toolbar-side-icon
          v-show="showSideBar"
        ...
        <div v-show="showSideBar">
          ...
          >
            <v-badge style="cursor: pointer" overlap color="#FFE700">
              <span
                slot="badge"
...
.router-link-active {
  color: #526da5;
  /* text-decoration: underline #ffe800; */
  ...
  /* box-shadow:
      ...
      inset 0 -0.3em #ffe800,
      inset 0 -0.15em white,
      inset 0 -0.3em #ffe800; */
  /* display: inline;
      box-shadow: 0px 2px 0px 500px #ffe800; */
  border-bottom: 5px solid #ffe800 !important;
}
.v-list__tile__title {
...
/* Emula estilos de "vínculos" internos creados con <li> */
.vinculo-externo {
  text-decoration: none;
  font-size: 13px;
  color: rgba(0, 0, 0, 0.87);
}
.v-list__group .v-list__group__items .v-list__tile__title {
  margin-left: 8px;
}
</style>
