...
export default class InformesGenerados extends Vue {
  ...
  async onGridReady(params: GridReadyEvent) {
    ...
    this.serverSide = {
      getRows(params: any): void {
        ...
        if (self.$route.path == '/informe-generado-vigilanti') {
          body.aplication = 'VIGILANTI';
        } else if (self.$route.path == '/informe-generado-camaras') {
          body.aplication = 'CAMARAS';
        }
